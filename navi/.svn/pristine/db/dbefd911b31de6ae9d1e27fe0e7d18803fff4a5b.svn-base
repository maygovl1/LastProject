	...
	<div class="view_inner">
			...
			<strong class="view-tit d-flex align-items-center">
				...
				<div class=" col-sm-11">
					<input type="text" class="form-control" placeholder="제목을입력해주세요"
						value="2024대덕인재개발원 리뉴얼 2024대덕인재개발원 리뉴얼 2024대덕인재개발원 리뉴얼 2024대덕인재개발원
					리뉴얼 2024대덕인재개발원 리뉴얼 2024대덕인재개발원 리뉴얼 2024대덕인재개발원 리뉴얼">
				</div>
		...
		<div class="view_content" id="viewEdit">
			...
			<input type="text" class="form-control" placeholder="내용을 입력해주세요"
				value="영화보러간 날 집에 가고 싶다. 잠이나 자고 싶다,영화가 넘 재미가 없다. 영화보러간 날 집에 가고 싶다. 잠이나 자고
			싶다,영화가 넘 재미가 없다. 영화보러간 날 집에 가고 싶다. 잠이나 자고 싶다,영화가 넘 재미가 없다. 영화보러간 날 집에
			가고 싶다. 잠이나 자고 싶다,영화가 넘 재미가 없다. 영화보러간 날 집에 가고 싶다. 잠이나 자고 싶다,영화가 넘 재미가
			없다.">
			<!-- 			</div> -->
...
<script>
	function moveDetail() {
		location.href = "${pageContext.request.contextPath }/board/share/detail"
	}
// 	추가된 상태
