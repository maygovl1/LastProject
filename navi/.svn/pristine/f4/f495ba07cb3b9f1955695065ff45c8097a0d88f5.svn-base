	...
	<form:form class="commonForm" method="post" modelAttribute="modEmp" enctype="multipart/form-data">
		<fieldset>
			...
			<div class="row text">
				...
				<div class="form_content col-sm-2">
			...
			<div class="row identifyNum">
				...
				<div class="form_content col-sm-2 d-flex">
			...
			<div class="row email">
				...
				<div class="form_content col-sm-7 d-flex">
					<div class="input col-sm-3">
			...
			<div class="row address">
				...
				<div class="form_content col-sm-9">
					<div class="input col-sm-3  d-flex mb-1">
            ...
            oncomplete: function(data) {
                ...
                if (data.userSelectedType === 'R') { 
                	...
                	if (data.buildingName != null) {
                		addr = data.roadAddress + " ("+ data.bname +", "+data.buildingName+")";
                	}
                } else { 
                	// 사용자가 지번 주소를 선택했을 경우
