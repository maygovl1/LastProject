					...
					<c:forEach items="${topPers }" var="emp">
						...
						<div class="item mx-auto mb-5 mb-lg-0" >
							...
							<div class="img-card" >
								...
								<img style="display:block; width:248.99px; height:auto;" class="img img-fluid rounded-circle mb-3"
										src="./resources/images/main/noImg.jpg" alt="...">
							</c:if>
							<c:if test="${not empty emp.base64Img}">
							<img class="img img-fluid rounded-circle mb-3"  style="display:block; width:248.99px; height:auto;" 
