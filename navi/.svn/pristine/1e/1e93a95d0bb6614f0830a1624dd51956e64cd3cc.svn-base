...
<%-- 자격증추천 모달 --%>
<div class="modal fade certRecomModal" id="certRecomModal" tabindex="-1" aria-labelledby="certRecomModal" aria-hidden="true">

	<div class="modal-dialog modal-lg">
		<div class="modal-content"  style="transform: translateY(10%)">
			<div class="modal-header bg-primary">
				<strong class="modal-title text-white" id="certRecomModal">자격증추천</strong>
			</div>
			<div class="modal-body" id="modalRecom">
				<div class="rowlist  common_list recomList" id="resultcertRecom">
				<!-- modal bottom -->
					<c:forEach items="${recomList}" var="cert">
						<div class=" col row  view" data-cert-id="${cert.certId}">
								<div class="photo_img">
									<div class="img-in">
										<img src="${pageContext.request.contextPath}${cert.certImgUrl}"
								...
								<div class="card-body">
									<ul class="ul">
										...
										<li><strong class="list-tit">자격증설명 :</strong>
											<p>${cert.certInfo } </p>
										</li>
