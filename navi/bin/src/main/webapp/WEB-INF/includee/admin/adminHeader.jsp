			...
			<nav class="sidenav clearfix ">
				<div class="sidenav-menu">
					<div class="nav accordion" id="accordionSidenav">
						...
						<!-- 사원관리(조회)-->
						<strong class="sidenav-menu-heading">관리</strong> <a
						...
						<div class="collapse" id="worker"
							...
							<nav class="sidenav-menu-nested nav">
								<a class="nav-link" href="">사원 조회</a> <a class="nav-link"
									href="">사원 초대</a> <a class="nav-link" href="">권한 부여</a> <a
									class="nav-link" href="">차단 관리</a>
							</nav>
						</div>
						<!-- 사원관리(조회 ,초대,권한설정)-->
						<!-- 프로젝트(조회,삭제복구)-->
						...
						<div class="collapse" id="project"
							data-bs-parent="#accordionSidenav" style="">
							<nav class="sidenav-menu-nested nav">
								<a class="nav-link" href="">조회 및 설정</a> <a class="nav-link"
									href="">프로젝트 복구</a>
							</nav>
						</div>
						<!-- 프로젝트(조회,삭제복구) -->
						...
						<div class="collapse " id="form"
							data-bs-parent="#accordionSidenav" style="">
							<nav class="sidenav-menu-nested nav">
								<a class="nav-link" href="">서식자료 관리</a>
						...
						<div class="collapse" id="community"
							data-bs-parent="#accordionSidenav" style="">
							<nav class="sidenav-menu-nested nav">
								<a class="nav-link" href="">도서추천 관리</a> <a class="nav-link"
									href="">칭찬공간 관리</a> <a class="nav-link" href="">나눔공간 관리</a>
							</nav>
						</div>
						<!-- 커뮤니티 (조회)-->
						...
						<a class="nav-link collapsed" href="javascript:void(0);"
							...
							</div> <strong class="depth1 tit">Q&A</strong>
							<div class="sidenav-collapse-arrow">
								<svg class="svg-inline--fa fa-angle-down" aria-hidden="true"
									focusable="false" data-prefix="fas" data-icon="angle-down"
									role="img" xmlns="http://www.w3.org/2000/svg"
						...
						<div class="collapse" id="manageqna"
							data-bs-parent="#accordionSidenav" style="">
							<nav class="sidenav-menu-nested nav">
								<a class="nav-link" href="">질문 관리</a> <a class="nav-link"
									href="">자주묻는 질문 관리</a>
							</nav>
						</div>
						<!-- 추천AI-->
						...
						<a class="nav-link collapsed" href="javascript:void(0);"
							...
							</div> <strong class="depth1 tit">데이터리포팅</strong>
							<div class="sidenav-collapse-arrow">
								<svg class="svg-inline--fa fa-angle-down" aria-hidden="true"
									focusable="false" data-prefix="fas" data-icon="angle-down"
									role="img" xmlns="http://www.w3.org/2000/svg"
					...
					<a class="nav-link logout" href="logout.jsp"> <strong
