	...
	<div class="view_inner">
		<div class="view-info">
			...
			<ul class="ul clearfix">
				...
				<li><span class="list-tit">진행기간</span> <span class=" col-sm-6"
					aria-label="Default select example">
						<div class="form-control">${project.ingProjectDT }</div>
				</span></li>
				...
				<!-- 											<span class=" col-sm-6" aria-label="Default select example"> -->
				<!-- 												<input class="form-control"type="date" value="2024.04.05"> -->
				<!-- 											</span> -->
				<!-- 										</li> -->
				<li><span class="list-tit">상태</span> <span> <select
						class="form-select" name="proStId" aria-label="Default select example">
							<c:forEach items="${projectStateList}" var="ps">
								<option value="${ps.cmId }">${ps.cmName}</option>
							</c:forEach>
					</select>
				</span></li>
				<li><span class="list-tit">현재 상태</span> <span class=" col-sm-6"
					aria-label="Default select example">
						<div class="form-control">${project.cmName }</div>
				</span></li>
				<!-- 프로젝트 상태값:
