...
<form:form action="${pageContext.request.contextPath}/project/issue/${issue.issueId }" id="updateForm">
		...
		<div class="view-info">
			...
			<ul class="ul clearfix">
				...
				<li><span class="list-tit">중요도</span><span class=" col-sm-6"
					aria-label="Default select example"><select class="form-select" name="imprtId">
				...
				<li><span class="list-tit">분류</span><span class=" col-sm-6"
					aria-label="Default select example"><select class="form-select" name="clsfcId" >
