					...
					<tbody>
						...
						<tr>
							...
							<td class="text-start"><a href="#"
								...
								</span> <em class="text-elipsis">[공지아이콘이 들어가야합니다] 포토게시판 사용방법 공지</em>
							</a></td>
							<td>ADMIN</td>
						...
						<tr>
							<th><input type="checkbox"></th>
							<th scope="row">나눔게시판</th>
							<td class="text-start"><a href="#"
								class="text-link d-flex new"> <span class="icon new_icon">
										<span class="sr-only">new</span>
								</span> <em class="text-elipsis">[공지아이콘이 들어가야합니다] 나눔게시판 사용방법 공지</em>
							</a></td>
							<td>ADMIN</td>
							<td>2024.02.05 14:25</td>
							<td><a href="" class="download_link" download=""><i
						...
						<tr>
							<th><input type="checkbox"></th>
							<th scope="row">칭찬게시판</th>
							<td class="text-start"><a href="#"
								class="text-link d-flex new"> <span class="icon new_icon">
										<span class="sr-only">new</span>
								</span> <em class="text-elipsis">[공지아이콘이 들어가야합니다] 칭찬게시판 사용방법 공지</em>
							</a></td>
							<td>ADMIN</td>
							<td>2024.02.05 14:25</td>
							<td><a href="" class="download_link" download=""><i
						...
						<tr>
							...
							<td class="text-start"><a href="#"
								class="text-link d-flex new"> <span class="icon new_icon">
										<span class="sr-only">new</span>
								</span> <em class="text-elipsis">[공지아이콘이 들어가야합니다] [필독]프로젝트 관련 이용수칙</em>
							</a></td>
							<td>ADMIN</td>
							<td>2024.02.05 14:25</td>
							<td><a href="" class="download_link" download=""><i
						...
						<tr>
							...
							<th scope="row">일반</th>
							<td class="text-start"><a href="#"
								class="text-link d-flex new"> <em class="text-elipsis">[공지아이콘이
										들어가야합니다] 공지사항 1</em>
							</a></td>
							<td>ADMIN</td>
							<td>2024.02.05 14:25</td>
