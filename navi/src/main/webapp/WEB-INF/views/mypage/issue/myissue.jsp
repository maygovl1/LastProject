...
<link type="text/css" rel="stylesheet"	href="<c:url value='/resources/css/mypage/mypage.css'/>" />
<form id="searchForm">
		...
		<c:forEach items="${issueList }" var="issue">
			<tr>
				<td>${issue.rnum }</td>
				 ...
				 <td><span class="category emergency text-elipsiss">${issue.proName }</span></td>
				<td class="text-start">
